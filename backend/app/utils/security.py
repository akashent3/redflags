...
# Password hashing context with Argon2 (modern, secure, no 72-byte limit)
...
def get_password_hash(password: str) -> str:
    ...
    Security:
        - Uses Argon2id variant (best for password hashing)
...
def verify_password(plain_password: str, hashed_password: str) -> bool:
    ...
    Security:
        ...
        - Handles both Argon2 and bcrypt for backwards compatibility
    """
    try:
