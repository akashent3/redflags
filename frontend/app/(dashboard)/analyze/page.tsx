    ...
    <div className="space-y-8">
      ...
      {activeTab === 'search' && (
        <div className="max-w-4xl">
              ...
              <div className="bg-blue-50 border border-blue-200 text-blue-800 px-4 py-3 rounded-md flex items-start gap-3 mb-6">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm mt-1">
                    Fetching latest annual report from NSE India and running analysis...
                  </p>
                </div>
              </div>
            )}
          ...
          <div className="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
            <p className="text-sm text-blue-800">
              <strong>How it works:</strong> Search for any NSE/BSE company, and we'll automatically
              fetch the latest annual report from NSE India, extract financial data from FinEdge API,
              and analyze 44+ red flags using AI. Analysis typically takes 1-2 minutes.
            </p>
          </div>
        </div>
      )}
